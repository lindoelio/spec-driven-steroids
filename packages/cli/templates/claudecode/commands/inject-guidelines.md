---
description: Generate or update project guideline documents using the project-guidelines-writer subagent
---
...
- Return the repository-analysis output expected by the subagent.
...
- Return the repository-insights output expected by the subagent.
...
- Generate these six documents by default:
  ...
  - `ARCHITECTURE.md`
  - `SECURITY.md`
- Use the Document Responsibility Matrix from the `project-guidelines-writer` subagent.
...
- Keep behavior aligned with the `project-guidelines-writer` subagent rather than adding platform-specific workflow rules.
