...
- Stop. Do not begin design work until the user explicitly approves Phase 1.
...
- Stop. Do not begin task decomposition until the user explicitly approves Phase 2.
...
- Stop. Do not begin implementation until the user explicitly approves Phase 3 and Phase 4 entry.
